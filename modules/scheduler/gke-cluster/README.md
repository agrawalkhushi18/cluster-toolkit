...
| Name | Description |
|------|-------------|
| <a name="output_access_token"></a> [access\_token](#output\_access\_token) | Access token to authenticate to the GKE cluster. |
| <a name="output_ca_certificate"></a> [ca\_certificate](#output\_ca\_certificate) | The GKE cluster CA certificate. |
...
| <a name="output_endpoint"></a> [endpoint](#output\_endpoint) | The GKE cluster endpoint. |
