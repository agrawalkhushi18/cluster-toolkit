...
| <a name="input_privileged_mode"></a> [privileged\_mode](#input\_privileged\_mode) | The privileged mode for the container. If true, the container has access to all host devices. | `bool` | `false` | no |
